        ...
        <section className="order-1 border-b border-border-default bg-bg-secondary px-6 py-4 sm:px-10 lg:order-1 lg:border-b-0 lg:border-r lg:px-6 lg:pb-10 lg:pt-20 xl:px-8" style={{ backgroundColor: 'var(--bg-secondary)', opacity: 1 }}>
          <div className="mx-auto flex w-full max-w-[1340px] flex-col gap-4 lg:items-start lg:gap-8">
            ...
            <div className="flex w-full min-w-0 flex-col items-start justify-between gap-5 lg:justify-start">
              ...
              <div className="flex shrink-0 items-center gap-3"><p className="hidden text-xs leading-5 text-text-secondary sm:block"><Link className="underline underline-offset-4" href="https://aksos.net/participate">Join Batana</Link>. <Link className="underline underline-offset-4" href="/sign-up"></Link></p><Link href="https://aksos.net" className="rounded border border-border-default bg-bg-primary px-3 py-2 font-mono text-[10px] uppercase tracking-[0.12em] text-text-primary transition hover:border-border-active">Back to AKSOS</Link></div>
            </div>
          </div>
        </section>
      </div>
