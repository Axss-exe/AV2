          ...
          <div className="flex items-center gap-2" style={{ marginBottom: 6, flexWrap: 'wrap' as const }}>
            ...
            <span
              style={{
                ...
                letterSpacing: '0.06em',
                textTransform: 'uppercase' as const,
                color: typeColor(opportunity.type ?? opportunity.opportunity_type ?? 'Unknown'),
                background: `${typeColor(opportunity.type ?? opportunity.opportunity_type ?? 'Unknown')}1a`,
                border: `1px solid ${typeColor(opportunity.type ?? opportunity.opportunity_type ?? 'Unknown')}33`,
                borderRadius: 4,
                padding: '2px 7px',
                fontFamily: 'var(--font-sans)',
              }}
