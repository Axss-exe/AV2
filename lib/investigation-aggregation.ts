...
/**
 * Merge accumulated query results into deduped entities, relationships, sources,
 * and findings without requiring the server-only database module.
 */
...
export default computeAggregated;
